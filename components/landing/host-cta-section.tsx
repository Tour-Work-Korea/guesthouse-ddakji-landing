    ...
    <section id="hosts" className="bg-primary/5 py-16 md:py-24 border-t border-border/40">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          {/* Content */}
          <div>
            <h2 className="mb-5 text-3xl font-bold text-foreground md:text-4xl leading-[1.3]">
              게딱지 파트너가 되어
              <br />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-6 mt-2">
              <Button
                size="lg"
                className="px-8 shadow-sm h-12 text-base font-semibold w-full sm:w-auto"
              >
                내 게스트하우스 등록하기
              </Button>
              ...
              <div className="flex items-center gap-3">
                <div className="flex -space-x-3">
                  <div className="w-9 h-9 rounded-full ring-2 ring-white dark:ring-background bg-muted overflow-hidden shadow-sm">
                  ...
                  <div className="w-9 h-9 rounded-full ring-2 ring-white dark:ring-background bg-primary/10 flex items-center justify-center text-xs font-bold text-primary shadow-sm">
                    +
                  </div>
                </div>
                <div className="text-sm font-medium text-muted-foreground leading-tight">
                  <span className="text-foreground font-bold">45+</span> 파트너<br />게스트하우스
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-border/60 bg-card p-8 md:p-12 shadow-sm relative overflow-hidden flex flex-col justify-center h-full min-h-[400px]">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-muted-foreground mb-10 leading-relaxed text-lg">
                언제 어디서나 스마트폰으로 간편하게 게스트하우스를 관리하세요. <br />
                예약 현황부터 정산, 스탭 관리까지 전용 앱 하나로 끝납니다.
              </p>

              <div className="flex flex-col xl:flex-row gap-4 mt-auto">
                <Button variant="outline" className="h-14 w-full flex-1 justify-center sm:justify-start px-4 gap-3 hover:bg-primary/5 hover:text-primary hover:border-primary/50 transition-all border-border/80">
                  <Apple className="w-6 h-6" />
                  <div className="flex flex-col items-start text-left">
                    <span className="text-[10px] uppercase tracking-wider font-semibold opacity-70 leading-none">Download on the</span>
                ...
                <Button variant="outline" className="h-14 w-full flex-1 justify-center sm:justify-start px-4 gap-3 hover:bg-primary/5 hover:text-primary hover:border-primary/50 transition-all border-border/80">
                  ...
                  <div className="flex flex-col items-start text-left">
                    <span className="text-[10px] uppercase tracking-wider font-semibold opacity-70 leading-none">Get it on</span>
