...
const footerLinks = {
  ...
  고객지원: [
    { label: "게스트 문의하기", href: "http://pf.kakao.com/_iLxiRX", external: true },
  ],
  약관: [
    ...
    <footer className="border-t border-border bg-card w-full mt-auto">
      <div className="container mx-auto px-6 py-12 lg:px-12 lg:py-16 max-w-[1440px]">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-8">
          ...
          {/* Links */}
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 sm:gap-12 lg:w-1/2 lg:justify-end mt-8 lg:mt-0">
